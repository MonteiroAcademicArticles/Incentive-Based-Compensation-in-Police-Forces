...
DROPBOX <- "C:/Users/mathi/OneDrive/Documents/GitHub/SIM"
GITHUB <- "C:/Users/mathi/OneDrive/Documents/GitHub/SIM"
...
depVars <- c("violent_death_sim",
             ...
             "involuntary_homicide_log",
             "other_homicides_log",
             "theft_log",
             "all_violent_deaths_log",
             "violent_death_sim_log",
             "vehicle_robbery_log",
             "street_robbery_log")
...
if(RUN_spatial_analysis){
  source(file.path(GITHUB, "03-robustness-spatial2.R"))
}
...
if(RUN_chaisemartin_analysis){
  source(file.path(GITHUB, "03-robustness-chaisemartin.R"))
}
