...
dd_formulas_poi <-
reg_formula(depVars,
              str_replace_all(poisson_indepVars_dd, 'hit_sem_l','hit_sem_fm_l'),
              FE_vars_dd)
...
tab5_addLines <- list(
  # c("Chief FE", rep(c( "Yes", "Yes", "Yes"), 3)),
  # c("AISP x Semester FE", rep(c("Yes", "Yes", "Yes", "Yes"), 3)),
